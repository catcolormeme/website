...
const DateRow: React.FC<React.PropsWithChildren<PropsType>> = ({ title, value, color }) => {
  ...
  const tooltipContent = t(
    `You will be able to withdraw the staked ${process.env.NEXT_PUBLIC_NAME_UPPER} and profit only when the staking position is unlocked, i.e. when the staking period ends.`,
  )
