...
export function AkkaAdvancedSwapDetails({
  route,
  inputAmountInDollar,
  outputAmountInDollar,
  outputAmountInDollarWithTax,
  ...
  const showRoute = () => {
    if (
      route !== undefined &&
      route?.routes?.[chainId.toString()] !== undefined &&
      route?.routes[chainId.toString()]?.length > 0
    ) {
      return true
    }
    return false
        ...
        <>
          ...
          {showRoute() && (
            <>
              ...
              <RowBetween style={{ width: '100%', padding: '0 16px', justifyContent: 'flex-end' }}>
                <Link
                  href="https://www.app.akka.finance/"
                  target="_blank"
                  style={{ color: isDark ? '#ffffff' : '#000000', fontSize: '12px', marginTop: '15px' }}
                >
                  {isDark ? (
                    <svg width="109" height="15" viewBox="0 0 109 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clipPath="url(#clip0_2245_16474)">
                        <path
                          d="M73 2V12H70.9103V3.73367H69.8654L68.5884 5.66834L64.409 12H62L68.5884 2H73Z"
                          fill="#ffffff"
                        />
                        <path
                          d="M99 2V12H100.9V3.73367H101.876L103.011 5.66834L106.81 12H109L103.011 2H99Z"
                          fill="#ffffff"
                        />
                        <path
                      ...
                      <defs>
                        <clipPath id="clip0_2245_16474">
                          <rect width="109" height="15" fill="#ffffff" />
                        </clipPath>
                      </defs>
                    </svg>
                  ) : (
                    <svg width="109" height="15" viewBox="0 0 109 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs>
                        <clipPath id="clip0_2245_16474">
                          <rect width="109" height="15" fill="#000000" />
                        </clipPath>
                      </defs>
                    </svg>
                  )}
