      ...
      >
        <Flex flex="1" flexDirection="column">
          <Heading as="h1" scale="xxl" color="secondary" mb="24px">
            {t(`${process.env.NEXT_PUBLIC_NAME} goes Core!`)}
          </Heading>
          <Heading scale="md" mb="24px" as="p" lineHeight="120%">
            {process.env.NEXT_PUBLIC_NAME} will be supporting the{' '}
            <Link display="inline-flex" href="https://coredao.org/">
              Core Chain
            </Link>{' '}
            from the start on. {process.env.NEXT_PUBLIC_NAME} offers a seamless trading experience for digital assets on
            Core with our swap. The core chain also will support our bridge, allowing users to easily and quickly
            transfer between different chains - <i>the fastest way to get you startet on Core</i>.
          </Heading>
          <Flex style={{ gap: '8px' }} flexDirection={['column', null, null, 'row']} alignItems="stretch">
            ...
            {SUPPORT_BRIDGE.includes(ChainId.BSC) && (
