...
export const CampaignOverview: React.FC<{ id: number }> = ({ id }) => {
  ...
  return (
    <AppWrapper
      hasBackButton
      title={`${t('Viewing')} ${token?.name} ${t('Campaign')}`}
      subtitle=""
      backlink="/launchpad"
    >
                    ...
                    <RowStyled>
                      <Td1>
                        <StyledFlex>
                          ...
                          <InfoTooltip
                            text={t(
                              'The soft cap is required for the campaign to succeed. If the soft cap is not reached you will get your funds back.',
                            )}
                          />
                        </StyledFlex>
                      </Td1>
                      ...
                      <RowStyled>
                        <Td1>
                          <StyledFlex>
                            ...
                            <InfoTooltip
                              text={t(
                                'The hard cap allows for additional contribution to the campaign. The remaining tokens of the hard cap will be burned. When the hard cap is reached, the campaign is locked for additional contributions.',
                              )}
                            />
                          </StyledFlex>
                        </Td1>
