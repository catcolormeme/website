...
describe('limitOrders/utils/getPriceForOneToken', () => {
  describe.each([
    [CurrencyAmount.fromRawAmount(WHALE, ONE), CurrencyAmount.fromRawAmount(BUSD, ONE), '1'],
    [CurrencyAmount.fromRawAmount(WHALE, FIVE), CurrencyAmount.fromRawAmount(BUSD, FIVE), '1'],
    [CurrencyAmount.fromRawAmount(WHALE, ONE), CurrencyAmount.fromRawAmount(BUSD, FIVE), '5'],
    [CurrencyAmount.fromRawAmount(WHALE, FIVE), CurrencyAmount.fromRawAmount(BUSD, ONE), '0.2'],
    ...
    [CurrencyAmount.fromRawAmount(WHALE, ZERO), CurrencyAmount.fromRawAmount(BUSD, ONE), undefined],
    [CurrencyAmount.fromRawAmount(WHALE, ONE), CurrencyAmount.fromRawAmount(BUSD, ZERO), undefined],
