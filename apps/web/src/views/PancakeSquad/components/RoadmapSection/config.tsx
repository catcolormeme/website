...
const config = ({ t }: FAQsType) => [
  {
    ...
    description: [
      ...
      t(`Multiple ${process.env.NEXT_PUBLIC_NAME} airdrops to the community`),
  ...
  },
  {
    ...
    description: [
      ...
      t(`More ${process.env.NEXT_PUBLIC_NAME} Airdrops`),
    ],
    reached: '07-2022',
  },
  {
    title: t('Multi Chain'),
    icon: '🌐',
    description: [t('Add more chains to our Bridge (Doken and Fuse)'), t('More AirDrops'), t('Super reliable Bridge')],
    reached: '10-2022',
  },
  {
    title: t('Expansion'),
    icon: '🚀',
    description: [t('Partnerships with many big upcoming chains'), t('More AirDrops')],
    reached: '11-2022',
  },
  {
    title: t('UI upgrades'),
  ...
  },
  {
    ...
    icon: '🛡️',
    description: [t('release of audit reports of all our smart contracts'), t('Add support for Base chain')],
    reached: '08-2023',
  },
  {
    ...
    description: [
      t(
        'Upgrade our DEX to support concentrated liquidity to drastically reduce slippage and increase capital efficiency',
      ),
  ...
  },
  {
    ...
    description: [
      t(
        'Add an insured speed boost to the Bridge, which offloads the risk to the insurer and completes Bridge near instant',
      ),
  ...
  },
  {
    ...
    icon: '🚀🚀',
    description: [
      t('Expand to a lot of blockchains and provide optimal dex routing on them thanks to our smart routing'),
    ],
    reached: '11-2023',
  },
]
