...
import { Text, Toggle, Flex, Modal, InjectedModalProps, ThemeSwitcher, Box, QuestionHelper } from '@pancakeswap/uikit'
import {
...
const SettingsModal: React.FC<React.PropsWithChildren<InjectedModalProps>> = ({ onDismiss, mode }) => {
  ...
  const [isAkkaSwapActive, toggleSetAkkaActiveToFalse, toggleSetAkkaActiveToTrue] = useIsAkkaSwapModeActive()
